      ...
      <div className="max-w-md w-full p-5 bg-white rounded-lg shadow-lg">
        ...
        <button
          onClick={() => {
            ...
            navigate(`/messages?name=${encodeURIComponent(user)}`, { replace: true });
          }}
        ...
        <button
          ...
          className="mt-4 w-full bg-red-500 hover:bg-red-600 text-white font-semibold py-3 rounded-lg transition duration-300 ease-in-out"
        >
          Sign in with Google
        </button>
      </div>
